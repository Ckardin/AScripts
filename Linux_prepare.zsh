...
sed -i '10a A_SHLIB=so' src/Makefile
sed -i '11a A_STLIB=a' src/Makefile
sed -i '12a A_EXT=' src/Makefile
sed -i '13a BINDIR=$(ASHES_DIR)/bin' src/Makefile
sed -i '14a LIBDIR=$(ASHES_DIR)/lib' src/Makefile
sed -i '15a INCDIR=$(ASHES_DIR)/inc' src/Makefile
